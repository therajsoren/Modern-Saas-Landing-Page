...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between p-4 shadow-[0px_20px_10px_8px_rgba(0,_0,_0,_0.1)] backdrop-blur-md sticky top-0 z-50 bg-gradient-to-r from-gray-400/50 to-gray-300/50 w-full mx-auto">
